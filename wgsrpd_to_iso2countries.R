...
wgsrpd_to_iso2country <-function(wgsrpd_regions){
  ...
  if(length(wgsrpd_regions)>0){
    ...
    tdwg<-read.csv("https://raw.githubusercontent.com/jannebor/pow_workaround/main/tdwg.csv?token=ARV5Z6PEKN7RH7WBTZSWQI273SEIG")
